    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 my-3 px-5 py-2 card">
                <div class="card-img">
                    <img src="{{asset('img/logo/edday_logo_banner.png')}}" alt="Edday logo" class="card-img-top img-fluid">
                </div>
                <form action="/register" method="POST" class="form-floating">
                    @csrf
                    <div class="form-floating my-3">
                        <input type="text" name="nome" id="floatingNome" placeholder="Nome" class="form-control" aria-describedby="nomeHelp" required>
                    ...
                    <div class="form-floating mb-3">
                        <input type="text" name="cognome" id="floatingCognome" placeholder="Cognome" class="form-control" aria-describedby="cognomeHelp" required>
                    ...
                    <div class="form-floating mb-3">
                      ...
                      <div class="form-floating mb-3">
                        <input type="password" class="form-control" name="password" id="floatingPassword" placeholder="Password" aria-describedby="passwordHelp" required>
                      ...
                      <div class="form-floating mb-3">
                        <select name="genere_preferito" id="floatingSelect" class="form-select" aria-describedby="genereHelp">
                        ...
                        <div class="form-text" id="genereHelp">
                            Scegliere un genere preferito ci aiuta a personalizzare i risultati, in futuro potrai cambiarlo
                        </div>
