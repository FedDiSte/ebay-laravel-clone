<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvas" aria-labelledby="offCanvasTitle">
    ...
    <div class="offcanvas-body">
        ...
        <div class="list-group mb-3">
            <a href="{{url('/profile')}}" class="list-group-item list-group-item-action"><i class="bi-person"></i> Il
                mio profilo</a>
        </div>
        <div class="list-group mb-3">
            <a href="{{url('/create-ad')}}" class="list-group-item list-group-item-action"><i class="bi-bag-plus"></i>
                Crea una nuova inserzione</a>
        </div>
        <div class="list-group mb-3">
            <a href="{{url('/my-ads')}}" class="list-group-item list-group-item-action"><i class="bi-check-circle"></i>
                Le mie inserzioni</a>
        </div>
